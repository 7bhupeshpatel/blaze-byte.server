...
exports.ENV = {
    ...
    CORS_ALLOWED_ORIGIN: (_a = process.env.CORS_ALLOWED_ORIGIN) === null || _a === void 0 ? void 0 : _a.split(','),
    ...
    IMAGE_QUALITY: 80,
    IMAGE_FORMAT: 'jpeg',
    MAX_FILE_SIZE: parseInt(process.env.MAX_FILE_SIZE || '1073741824'),
    UPLOAD_TIMEOUT: parseInt(process.env.UPLOAD_TIMEOUT || '1200000'),
    AZURE_UPLOAD_BLOCK_SIZE: parseInt(process.env.AZURE_UPLOAD_BLOCK_SIZE || '4194304'),
