...
exports.placeGuestOrder = exports.getCompanyMenu = void 0;
...
const placeGuestOrder = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const order = yield guest_service_1.GuestService.placeOrder(companyId, items, customerName, customerPhone, guestId);
